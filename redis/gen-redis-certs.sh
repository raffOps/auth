...
generate_cert server "Server-only" "-extfile tls/openssl.cnf -extensions server_cert -extensions SAN"
generate_cert client "Client-only" "-extfile tls/openssl.cnf -extensions client_cert -extensions SAN"
generate_cert redis "Generic-cert" "-extfile tls/openssl.cnf -extensions SAN"
